...
/****** Object:  Database [Ticketmaster]    Script Date: 24/02/2018 10:12:37 a.m. ******/
...
CREATE DATABASE [Ticketmaster]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Ticketmaster', FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\Ticketmaster.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Ticketmaster_log', FILENAME = N'C:\Program Files (x86)\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\Ticketmaster_log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
